...
function TeacherView(props) {
    ...
    const { reload, status, data } = props
    ...
    function getListStudentView(params ,sort, fieldName, defautSort) {
        UserService.getListUserFollowRole({ ...params, role: 'teacher', paging: true },
            res => {
    ...
    function handleDetail(row) {
        history.push(`/users/${row.id}/detail?type=TeacherInformation`)
    }
